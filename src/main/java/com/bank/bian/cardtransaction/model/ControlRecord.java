package com.bank.bian.cardtransaction.model;
...
/**
 * The BIAN control record for this service domain: "Card Transaction Procedure".
 *
 ...
 * to its asset type (Card Transaction). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Card Transaction Procedure";
